...
const JSBI = _interopDefault(require('jsbi'))
const invariant = _interopDefault(require('tiny-invariant'))
const warning = _interopDefault(require('tiny-warning'))
const address = require('@ethersproject/address')
const _Big = _interopDefault(require('big.js'))
const toFormat = _interopDefault(require('toformat'))
const _Decimal = _interopDefault(require('decimal.js-light'))
const solidity = require('@ethersproject/solidity')
const contracts = require('@ethersproject/contracts')
const networks = require('@ethersproject/networks')
const providers = require('@ethersproject/providers')
const IUniswapV2Pair = _interopDefault(require('@uniswap/v2-core/build/IUniswapV2Pair.json'))

let _SOLIDITY_TYPE_MAXIMA
;(function(ChainId) {
...
const FACTORY_ADDRESS = '0x643dA4b01FED3B245BE37E756c131052337E178a'
const INIT_CODE_HASH = '1892ee6b3b8f653471529d0b06a772bdc5588bb0b15607cb427c8148f70004a9'
...
const InsufficientReservesError = /*#__PURE__*/ (function(_Error) {
...
const InsufficientInputAmountError = /*#__PURE__*/ (function(_Error2) {
...
const Token = /*#__PURE__*/ (function(_Currency) {
...
const WETH =
  ...
  (_WETH[exports.ChainId.BLAST] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.TAIKO] = /*#__PURE__*/ new Token(
    exports.ChainId.TAIKO,
    '0xA51894664A773981C6C112C43ce576f315d5b1B6',
    18,
    'WETH',
    'Wrapped Ether'
  )),
  (_WETH[exports.ChainId.ARBITRUM_SEPOLIA] = /*#__PURE__*/ new Token(
...
let _toSignificantRoundin, _toFixedRounding
...
const toSignificantRounding =
  ...
  (_toSignificantRoundin[exports.Rounding.ROUND_HALF_UP] = Decimal.ROUND_HALF_UP),
...
const toFixedRounding =
  ...
  _toFixedRounding)
const Fraction = /*#__PURE__*/ (function() {
  ...
  const _proto = Fraction.prototype
...
const CurrencyAmount = /*#__PURE__*/ (function(_Fraction) {
  ...
  const _proto = CurrencyAmount.prototype
...
const TokenAmount = /*#__PURE__*/ (function(_CurrencyAmount) {
  ...
  const _proto = TokenAmount.prototype
...
const Price = /*#__PURE__*/ (function(_Fraction) {
  ...
  _proto.multiply = function multiply(other) {
    ...
    const fraction = _Fraction.prototype.multiply.call(this, other)
...
const Pair = /*#__PURE__*/ (function() {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    let _PAIR_ADDRESS_CACHE, _PAIR_ADDRESS_CACHE$t
    ...
    if (
      ...
      let _PAIR_ADDRESS_CACHE2, _extends2, _extends3
...
const Percent = /*#__PURE__*/ (function(_Fraction) {
  ...
  const _proto = Percent.prototype
...
const Trade = /*#__PURE__*/ (function() {
  function Trade(route, amount, tradeType) {
    ...
    if (tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      for (let i = 0; i < route.path.length - 1; i++) {
        ...
        const _pair$getOutputAmount = pair.getOutputAmount(amounts[i]),
      ...
      for (let _i = route.path.length - 1; _i > 0; _i--) {
        const _pair = route.pairs[_i - 1]

        const _pair$getInputAmount = _pair.getInputAmount(amounts[_i]),
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(
    ...
    for (let i = 0; i < pairs.length; i++) {
      ...
      try {
        const _pair$getOutputAmount2 = pair.getOutputAmount(amountIn)
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(
          bestTrades,
          new Trade(
            new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut),
            originalAmountIn,
  ...
  Trade.bestTradeExactOut = function bestTradeExactOut(
    ...
    for (let i = 0; i < pairs.length; i++) {
      ...
      try {
        const _pair$getInputAmount2 = pair.getInputAmount(amountOut)
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(
          bestTrades,
          new Trade(
            new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency),
            originalAmountOut,
...
const Router = /*#__PURE__*/ (function() {
  /**
...
const Fetcher = /*#__PURE__*/ (function() {
  /**
   * Cannot be constructed.
   */
  function Fetcher() {}
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      let _TOKEN_DECIMALS_CACHE2, _TOKEN_DECIMALS_CACHE3

      const _temp3 = function _temp3(parsedDecimals) {
        ...
        _temp4
          ...
          : Promise.resolve(
              new contracts.Contract(address, ERC20, provider).decimals().then(function(decimals) {
                let _TOKEN_DECIMALS_CACHE4, _extends2, _extends3
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IUniswapV2Pair.abi, provider).getReserves()).then(function(
        _ref
      ) {
        const reserves0 = _ref[0],
          reserves1 = _ref[1]
