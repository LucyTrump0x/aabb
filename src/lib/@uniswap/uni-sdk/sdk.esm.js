...
const WETH =
  ...
  (_WETH[ChainId.BLAST] = /*#__PURE__*/ new Token(
    ChainId.BLAST,
  ...
  (_WETH[ChainId.TAIKO] = /*#__PURE__*/ new Token(
    ChainId.TAIKO,
  ...
  (_WETH[ChainId.ARBITRUM_SEPOLIA] = /*#__PURE__*/ new Token(
...
const Pair = /*#__PURE__*/ (function() {
  ...
  _proto.getLiquidityMinted = function getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
    !totalSupply.token.equals(this.liquidityToken)
      ? process.env.NODE_ENV !== 'production'
  ...
  _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
    ...
    !totalSupply.token.equals(this.liquidityToken)
      ? process.env.NODE_ENV !== 'production'
        ...
        : invariant(false)
      : void 0
    !liquidity.token.equals(this.liquidityToken)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'LIQUIDITY')
        : invariant(false)
      : void 0
...
let TOKEN_DECIMALS_CACHE =
  ...
  (_TOKEN_DECIMALS_CACHE[ChainId.MAINNET] = {
