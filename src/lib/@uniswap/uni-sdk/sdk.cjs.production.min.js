...
;((n = exports.ChainId || (exports.ChainId = {}))[(n.MAINNET = 1)] = 'MAINNET'),
  (n[(n.BLAST = 81457)] = 'BLAST'),
  (n[(n.TAIKO = 167e3)] = 'TAIKO'),
  (n[(n.ARBITRUM_SEPOLIA = 421614)] = 'ARBITRUM_SEPOLIA'),
  ((r = exports.TradeType || (exports.TradeType = {}))[(r.EXACT_INPUT = 0)] = 'EXACT_INPUT'),
  (r[(r.EXACT_OUTPUT = 1)] = 'EXACT_OUTPUT'),
  ((o = exports.Rounding || (exports.Rounding = {}))[(o.ROUND_DOWN = 0)] = 'ROUND_DOWN'),
  (o[(o.ROUND_HALF_UP = 1)] = 'ROUND_HALF_UP'),
  (o[(o.ROUND_UP = 2)] = 'ROUND_UP')
let v,
  y = '1892ee6b3b8f653471529d0b06a772bdc5588bb0b15607cb427c8148f70004a9',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
const q =
  (((e = {})[v.uint8] = i.BigInt('0xff')),
  (e[v.uint256] = i.BigInt('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff')),
  e)
function P(t, e) {
...
function B(t) {
  ...
  return (B = function(t) {
    ...
    function n() {
      return D(t, arguments, N(this).constructor)
    }
    return (
...
const M = 'setPrototypeOf' in Object,
  L = (function(t) {
    function e() {
      let n
      return (
        ...
        M && Object.setPrototypeOf(F(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return _(e, t), e
...
function Y(t) {
  ...
  let e,
    n = T
  if (i.greaterThan(t, A))
    for (n = t, e = i.add(i.divide(t, k), g); i.lessThan(e, n); ) (n = e), (e = i.divide(i.add(i.divide(t, e), e), k))
  ...
  G = (function(t) {
    ...
    return (
      ...
      (n.sortsBefore = function(t) {
        return (
          this.chainId !== t.chainId && u(!1),
          this.address === t.address && u(!1),
...
let tt,
  et,
  nt =
    (((Q = {})[exports.ChainId.MAINNET] = new G(
    ...
    (Q[exports.ChainId.ARBITRUM_SEPOLIA] = new G(
  ...
  ot = c(s),
  it =
    (((tt = {})[exports.Rounding.ROUND_DOWN] = rt.ROUND_DOWN),
    (tt[exports.Rounding.ROUND_HALF_UP] = rt.ROUND_HALF_UP),
    (tt[exports.Rounding.ROUND_UP] = rt.ROUND_UP),
    tt),
  ut =
    (((et = {})[exports.Rounding.ROUND_DOWN] = 0),
    (et[exports.Rounding.ROUND_HALF_UP] = 1),
    (et[exports.Rounding.ROUND_UP] = 3),
    et),
  at = (function() {
    function t(t, e) {
    ...
    return (
      ...
      (e.add = function(e) {
        const n = e instanceof t ? e : new t(V(e))
      ...
      (e.toSignificant = function(t, e, n) {
        void 0 === e && (e = { groupSeparator: '' }),
          void 0 === n && (n = exports.Rounding.ROUND_HALF_UP),
          Number.isInteger(t) || u(!1),
          t > 0 || u(!1),
          rt.set({ precision: t + 1, rounding: it[n] })
        const r = new rt(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(t)
      ...
      (e.toFixed = function(t, e, n) {
        return (
          ...
          (ot.DP = t),
          (ot.RM = ut[n]),
          new ot(this.numerator.toString()).div(this.denominator.toString()).toFormat(t, e)
        )
      }),
      R(t, [
        {
  ...
  ct = (function(t) {
    ...
    return (
      ...
      (n.toSignificant = function(e, n, r) {
        return (
          void 0 === e && (e = 6),
          void 0 === r && (r = exports.Rounding.ROUND_DOWN),
          t.prototype.toSignificant.call(this, e, n, r)
        )
      }),
      (n.toFixed = function(e, n, r) {
        return (
          void 0 === e && (e = this.currency.decimals),
          void 0 === r && (r = exports.Rounding.ROUND_DOWN),
          e <= this.currency.decimals || u(!1),
          t.prototype.toFixed.call(this, e, n, r)
        )
      }),
      (n.toExact = function(t) {
        return (
          void 0 === t && (t = { groupSeparator: '' }),
          (st.DP = this.currency.decimals),
          new st(this.numerator.toString()).div(this.denominator.toString()).toFormat(t)
        )
      }),
      R(e, [
        {
  ...
  pt = (function(t) {
    function e(e, n, r, o) {
      let u
      return (
        ((u = t.call(this, o, r) || this).baseCurrency = e),
        (u.quoteCurrency = n),
        (u.scalar = new at(i.exponentiate(I, i.BigInt(e.decimals)), i.exponentiate(I, i.BigInt(n.decimals)))),
        u
      )
    }
    _(e, t),
      (e.fromRoute = function(t) {
        for (var n, r = [], o = H(t.pairs.entries()); !(n = o()).done; ) {
          const i = n.value,
            u = i[1]
          r.push(
            t.path[i[0]].equals(u.token0)
              ? new e(u.reserve0.currency, u.reserve1.currency, u.reserve0.raw, u.reserve1.raw)
              : new e(u.reserve1.currency, u.reserve0.currency, u.reserve1.raw, u.reserve0.raw)
          )
        }
    ...
    return (
      ...
      (n.multiply = function(n) {
        ...
        const r = t.prototype.multiply.call(this, n)
        return new e(this.baseCurrency, n.quoteCurrency, r.denominator, r.numerator)
      }),
      (n.quote = function(e) {
        return (
          Z(e.currency, this.baseCurrency) || u(!1),
          this.quoteCurrency instanceof G
            ? new dt(this.quoteCurrency, t.prototype.multiply.call(this, e.raw).quotient)
            : ct.ether(t.prototype.multiply.call(this, e.raw).quotient)
        )
      }),
  ...
  lt = (function() {
    function t(e, n) {
      const r = e.token.sortsBefore(n.token) ? [e, n] : [n, e]
      ;(this.liquidityToken = new G(
        r[0].token.chainId,
        t.getAddress(r[0].token, r[1].token),
        18,
        'UNI-V2',
        'Uniswap V2'
      )),
    ...
    t.getAddress = function(t, e) {
      ...
      return (
        void 0 ===
          (null === (n = ft) || void 0 === n || null === (r = n[s[0].address]) || void 0 === r
            ? void 0
            : r[s[1].address]) &&
          (ft = U(
            {},
            ...
            (((u = {})[s[0].address] = U(
              {},
              null === (o = ft) || void 0 === o ? void 0 : o[s[0].address],
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0x643dA4b01FED3B245BE37E756c131052337E178a',
                p.keccak256(['bytes'], [p.pack(['address', 'address'], [s[0].address, s[1].address])]),
                y
              )),
              i)
            )),
    ...
    return (
      ...
      (e.getOutputAmount = function(e) {
        if ((this.involvesToken(e.token) || u(!1), i.equal(this.reserve0.raw, T) || i.equal(this.reserve1.raw, T)))
          throw new L()
        const n = this.reserveOf(e.token),
          r = this.reserveOf(e.token.equals(this.token0) ? this.token1 : this.token0),
          o = i.multiply(e.raw, E),
          a = i.multiply(o, r.raw),
          s = i.add(i.multiply(n.raw, b), o),
          c = new dt(e.token.equals(this.token0) ? this.token1 : this.token0, i.divide(a, s))
        if (i.equal(c.raw, T)) throw new W()
        return [c, new t(n.add(e), r.subtract(c))]
      }),
      (e.getInputAmount = function(e) {
        if (
          (this.involvesToken(e.token) || u(!1),
          i.equal(this.reserve0.raw, T) ||
            i.equal(this.reserve1.raw, T) ||
            i.greaterThanOrEqual(e.raw, this.reserveOf(e.token).raw))
        )
          throw new L()
        const n = this.reserveOf(e.token),
          r = this.reserveOf(e.token.equals(this.token0) ? this.token1 : this.token0),
          o = i.multiply(i.multiply(r.raw, e.raw), b),
          a = i.multiply(i.subtract(n.raw, e.raw), E),
      ...
      (e.getLiquidityMinted = function(t, e, n) {
        ...
        if (((o[0].token.equals(this.token0) && o[1].token.equals(this.token1)) || u(!1), i.equal(t.raw, T)))
          r = i.subtract(Y(i.multiply(o[0].raw, o[1].raw)), w)
        else {
          const a = i.divide(i.multiply(o[0].raw, t.raw), this.reserve0.raw),
            s = i.divide(i.multiply(o[1].raw, t.raw), this.reserve1.raw)
          r = i.lessThanOrEqual(a, s) ? a : s
        }
        if (!i.greaterThan(r, T)) throw new W()
      ...
      (e.getLiquidityValue = function(t, e, n, r, o) {
        ...
        if (
          (void 0 === r && (r = !1),
          this.involvesToken(t) || u(!1),
          e.token.equals(this.liquidityToken) || u(!1),
          n.token.equals(this.liquidityToken) || u(!1),
          i.lessThanOrEqual(n.raw, e.raw) || u(!1),
          r)
        ) {
          o || u(!1)
          const s = V(o)
          if (i.equal(s, T)) a = e
            ...
            const c = Y(i.multiply(this.reserve0.raw, this.reserve1.raw)),
              d = Y(s)
            if (i.greaterThan(c, d)) {
              const p = i.multiply(e.raw, i.subtract(c, d)),
  ...
  ht = (function() {
    function t(t, e, n) {
      t.length > 0 || u(!1),
        ...
        (e instanceof G && t[0].involvesToken(e)) || (e === z && t[0].involvesToken(nt[t[0].chainId])) || u(!1),
        void 0 === n ||
          (n instanceof G && t[t.length - 1].involvesToken(n)) ||
          (n === z && t[t.length - 1].involvesToken(nt[t[0].chainId])) ||
          u(!1)
      for (var r, o = [e instanceof G ? e : nt[t[0].chainId]], i = H(t.entries()); !(r = i()).done; ) {
        const a = r.value,
          s = a[1],
          c = o[a[0]]
        c.equals(s.token0) || c.equals(s.token1) || u(!1)
        const d = c.equals(s.token0) ? s.token1 : s.token0
        o.push(d)
      }
      ;(this.pairs = t),
        (this.path = o),
        (this.midPrice = pt.fromRoute(this)),
        (this.input = e),
...
function yt(t, e) {
  return (
    Z(t.inputAmount.currency, e.inputAmount.currency) || u(!1),
    Z(t.outputAmount.currency, e.outputAmount.currency) || u(!1),
...
function Tt(t, e) {
  return t instanceof dt ? t : t.currency === z ? new dt(nt[e], t.raw) : void u(!1)
}
function gt(t, e) {
  return t instanceof G ? t : t === z ? nt[e] : void u(!1)
}
const kt = (function() {
  function t(t, e, n) {
    let r,
    ...
    if (n === exports.TradeType.EXACT_INPUT) {
      ...
      for (let c = 0; c < t.path.length - 1; c++) {
        const d = t.pairs[c].getOutputAmount(a[c]),
          p = d[1]
        ;(a[c + 1] = d[0]), (s[c] = p)
      }
    } else {
      ...
      for (let f = t.path.length - 1; f > 0; f--) {
        const l = t.pairs[f - 1].getInputAmount(a[f]),
          h = l[1]
        ;(a[f - 1] = l[0]), (s[f - 1] = h)
      }
    }
    ;(this.route = t),
      (this.tradeType = n),
      (this.inputAmount = n === exports.TradeType.EXACT_INPUT ? e : t.input === z ? ct.ether(a[0].raw) : a[0]),
      (this.outputAmount =
        n === exports.TradeType.EXACT_OUTPUT ? e : t.output === z ? ct.ether(a[a.length - 1].raw) : a[a.length - 1]),
      (this.executionPrice = new pt(
        this.inputAmount.currency,
        this.outputAmount.currency,
        this.inputAmount.raw,
        this.outputAmount.raw
      )),
      (this.nextMidPrice = pt.fromRoute(new ht(s, t.input))),
      (this.priceImpact =
        ((r = this.outputAmount),
        (i = (o = t.midPrice.raw.multiply(this.inputAmount.raw)).subtract(r.raw).divide(o)),
        new vt(i.numerator, i.denominator)))
  }
  ...
  return (
    ...
    (e.maximumAmountIn = function(t) {
      ...
      const e = new at(g).add(t).multiply(this.inputAmount.raw).quotient
    ...
    (t.bestTradeExactIn = function(e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === n || i.length > 0 || u(!1)
      const h = n instanceof dt ? n.token.chainId : r instanceof G ? r.chainId : void 0
      void 0 === h && u(!1)
      for (let m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        const w = e[y]
        if (
          (w.token0.equals(m.token) || w.token1.equals(m.token)) &&
          !w.reserve0.equalTo(T) &&
          !w.reserve1.equalTo(T)
        ) {
          let g = void 0
          try {
          ...
          if (g.token.equals(v))
            J(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), p, wt)
          else if (l > 1 && e.length > 1) {
            const k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactIn(k, g, r, { maxNumResults: p, maxHops: l - 1 }, [].concat(i, [w]), a, s)
          }
        }
      }
      return s
    ...
    (t.bestTradeExactOut = function(e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === r || i.length > 0 || u(!1)
      const h = r instanceof dt ? r.token.chainId : n instanceof G ? n.chainId : void 0
      void 0 === h && u(!1)
      for (let m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        const w = e[y]
        if (
          (w.token0.equals(m.token) || w.token1.equals(m.token)) &&
          !w.reserve0.equalTo(T) &&
          ...
          if (g.token.equals(v))
            J(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), p, wt)
          else if (l > 1 && e.length > 1) {
            const k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactOut(k, n, g, { maxNumResults: p, maxHops: l - 1 }, [w].concat(i), a, s)
          }
        }
      }
      return s
...
let xt,
  It = (function() {
    ...
    return (
      (t.swapCallParameters = function(t, e) {
        const n = t.inputAmount.currency === z,
          r = t.outputAmount.currency === z
        n && r && u(!1), !('ttl' in e) || e.ttl > 0 || u(!1)
        let o,
          i,
          a,
          s = K(e.recipient),
        ...
        switch (t.tradeType) {
          case exports.TradeType.EXACT_INPUT:
            n
              ? ((o = l ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
                (i = [d, p, s, f]),
                (a = c))
              : r
              ? ((o = l ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
                (i = [c, d, p, s, f]),
                (a = '0x0'))
              : ((o = l ? 'swapExactTokensForTokensSupportingFeeOnTransferTokens' : 'swapExactTokensForTokens'),
                (i = [c, d, p, s, f]),
                (a = '0x0'))
            break
          case exports.TradeType.EXACT_OUTPUT:
            l && u(!1),
              n
                ? ((o = 'swapETHForExactTokens'), (i = [d, p, s, f]), (a = c))
                : r
                ? ((o = 'swapTokensForExactETH'), (i = [d, c, p, s, f]), (a = '0x0'))
                : ((o = 'swapTokensForExactTokens'), (i = [d, c, p, s, f]), (a = '0x0'))
        }
        return { methodName: o, args: i, value: a }
      }),
      t
    )
  })(),
  ...
  Et = (((xt = {})[exports.ChainId.MAINNET] = { '0xE0B7927c4aF23765Cb51314A0E0521A9645F0E2A': 9 }), xt),
  bt = (function() {
    function t() {}
    return (
      (t.fetchTokenData = function(t, e, n, r, o) {
        try {
          let i,
            u,
            a = function(n) {
              return new G(t, e, n, r, o)
            }
          void 0 === n && (n = h.getDefaultProvider(l.getNetwork(t)))
          const s =
            'number' ==
            typeof (null === (i = Et) || void 0 === i || null === (u = i[t]) || void 0 === u ? void 0 : u[e])
          return Promise.resolve(
            s
              ? a(Et[t][e])
              : Promise.resolve(
                  new f.Contract(e, Ot, n).decimals().then(function(n) {
                    let r, o, i
                    return (
                      (Et = U(
                        {},
...
;(exports.JSBI = i),
  (exports.Currency = $),
  (exports.CurrencyAmount = ct),
  (exports.ETHER = z),
  (exports.FACTORY_ADDRESS = '0x643dA4b01FED3B245BE37E756c131052337E178a'),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
  (exports.INIT_CODE_HASH = y),
  (exports.InsufficientInputAmountError = W),
  (exports.InsufficientReservesError = L),
  (exports.MINIMUM_LIQUIDITY = w),
  (exports.Pair = lt),
  (exports.Percent = vt),
  (exports.Price = pt),
  (exports.Route = ht),
  (exports.Router = It),
  (exports.Token = G),
  (exports.TokenAmount = dt),
  (exports.Trade = kt),
  (exports.WETH = nt),
  (exports.currencyEquals = Z),
  (exports.inputOutputComparator = yt),
  (exports.tradeComparator = wt)
